...
def generate_unique_account_no(
    db: Session, organisation_id: str, product_prefix: str = "101"
) -> str:
    """
    ...
    # Clean the UUID to ensure valid SQL identifier
    org_clean = str(organisation_id).replace("-", "_")
    seq_name = f"seq_acc_{org_clean}_{product_prefix}"
